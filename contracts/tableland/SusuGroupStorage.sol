...
contract SusuGroupStorage is ERC721Holder {
    // Store relevant table info
    uint256 private _tableId; // Unique table ID
    uint256 private primaryKey = 0;
    string private constant _TABLE_PREFIX = "susu_groups_table"; // Custom table prefix
    ...
    function insertIntoTable( address groupId, address memberAddress) external {
